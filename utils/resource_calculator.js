...
const onGridchange = (e) => {
    ...
    if ($ironworks_ip2.value > 0) {
        ...
        $ironworks_op1.value = $ironworks_ip2.value * 4
        $ironworks_op2.value = $ironworks_ip2.value * 16
    ...
    if ($sawmill_ip2.value == 0 && $ironmine_ip2.value == 0 && $smelter_ip2.value == 0 && $coalmine_ip2.value == 0 && $ironworks_ip2.value == 0 && $oilfield_ip2.value == 0 && $refinery_ip2.value == 0) {
        reset_board()
    }
    else {
